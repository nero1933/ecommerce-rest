...
router_accounts.register(r'orders', OrderReadOnlyViewSet, basename='order')
...
urlpatterns = [
    ...
    path('api/v1/accounts/orders/<int:order_id>/product/<int:ordered_item_id>/review/', ReviewCreateAPIView.as_view(), name='create_review'),
